...
public:
	...
	virtual uint32_t write( const uint8_t* data, uint32_t size, sysinterval_t timeout ) = 0;
	virtual uint32_t read( uint8_t* data, uint32_t size, sysinterval_t timeout ) = 0;
