...
SET(CMAKE_CXX_FLAGS "-mthumb -fno-exceptions -fno-builtin -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=soft -Wall -std=c++14 -ffunction-sections -fdata-sections -fomit-frame-pointer -mabi=aapcs -fno-unroll-loops -ffast-math -ftree-vectorize" CACHE INTERNAL "cxx compiler flags")
...
IF(USE_PRINTF_FLOAT)
    SET(STM32_PRINTF_FLOAT_LINKER_FLAG "-u _printf_float")
ENDIF()
IF(USE_SCANF_FLOAT)
    SET(STM32_SCANF_FLOAT_LINKER_FLAG "-u _scanf_float")
ENDIF()
SET(CMAKE_EXE_LINKER_FLAGS "-Wl,--gc-sections --specs=nosys.specs --specs=nano.specs ${STM32_PRINTF_FLOAT_LINKER_FLAG} ${STM32_SCANF_FLOAT_LINKER_FLAG} -mthumb -mcpu=cortex-m4 -mfpu=fpv4-sp-d16 -mfloat-abi=soft -mabi=aapcs" CACHE INTERNAL "executable linker flags")
